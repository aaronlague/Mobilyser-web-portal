...
<div class="container">
  ...
  <div id="errMsg"></div>
    ...
    <div class="tab-content">
      <div class="tab-pane active" id="bills"><?php include ('../mobilyser-beta/view/bills-framed.php'); ?></div>
      <div class="tab-pane" id="calls"><?php include ('../mobilyser-beta/view/calls.php'); ?></div>
      <div class="tab-pane" id="contacts"><?php include ('../mobilyser-beta/view/contacts.php'); ?></div>
	  <div class="tab-pane" id="reports"><?php include ('../mobilyser-beta/view/reports.php'); ?></div>
    </div>
  </div>
</div>
<!-- /.container -->
